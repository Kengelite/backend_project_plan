...
use App\Services\Admin\Manage\OkrProjectService;
use App\Trait\Utils;
use Illuminate\Http\Request;

class OkrProjectController extends Controller
{
    use Utils;
    /**
    ...
    public function update(Request $request, OkrProjectService $projectService)
    {
        try {
            $id = $request->okr_project_id;
    ...
    public function store(Request $request,OkrProjectService $projectService)
    {
        try {
            $id_okr = $request->id_okr;
     ...
     */
    public function destroy(OkrProjectService $projectService, Request $request)
    {
        try {
            $id = $request->okr_project_id;
